class Config {
  ...
  static String englishUrl = "https://macidp.com/en/wp-json/wc/v3/";
  static String customerUrl = "customers";
  static String productsUrl = "products";
  static String categoriesUrl = "categories";
  static String externalUrl = "License/External";
  static String orderUrl = "https://mobile.macxbackupxdata.space/api/";
}
